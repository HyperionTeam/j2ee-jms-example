...
public class TBorrowerDuration implements MessageListener {
    ...
    public TBorrowerDuration(String topiccf, String topicName, String rate) {    	
    	try {
			...
			TopicSubscriber subscriber = tSession.createDurableSubscriber(topic,"DurableSubscriber");
...
//    	}
    	...
    	TBorrowerDuration borrower = new TBorrowerDuration(topiccf, topicName, rate);
