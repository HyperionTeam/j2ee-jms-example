...
public class TBorrower2 implements MessageListener {
    ...
    public TBorrower2(String topiccf, String topicName, String rate) {    	
    	try {
...
//    	}
    	...
    	TBorrower2 borrower = new TBorrower2(topiccf, topicName, rate);
